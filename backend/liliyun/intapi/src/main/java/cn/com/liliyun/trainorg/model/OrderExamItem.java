...
public class OrderExamItem extends BaseModel implements Serializable {
    ...
    @Excel(name="预约科目",replace={"科目一_0","科目二_1","科目三_2","科目四_3"})
    private Integer subject;

    @Excel(name="预约结果",replace={"预约失败_1","预约成功_0"})
