...
public class TheoryLessonStoreDto extends BaseModel{
    ...
    private Integer recomnumStore;

    private Integer arrangenumStore;
	...
	public Integer getRecomnumStore() {
		return recomnumStore;
	}

	public void setRecomnumStore(Integer recomnumStore) {
		this.recomnumStore = recomnumStore;
	}

	public Integer getArrangenumStore() {
		return arrangenumStore;
	}

	public void setArrangenumStore(Integer arrangenumStore) {
		this.arrangenumStore = arrangenumStore;
	}
